...
vetor de structs contendo as seguintes informações, 
para cada veículo: 
	-placa, 
	-modelo, 
	-marca, 
	-cor,
	-quilometragem, 
	-ano modelo/fabricação (deve ser um struct), 
	-valor, 
...
veículos da loja, incluindo todas as declarações de tipos que
possam ser necessárias. Além disso, implementar as seguintes funções:
